...
> Delivered historical repair. Current lifecycle architecture is consolidated
> in [SDD lifecycle integration and safe recovery](../../sdd-lifecycle-integration-and-safe-recovery.md).

...
Completed on 2026-08-22: the released runtime initialized the new closeout
controller with exact matching identities, after the self-inventory repair
removed the false legacy ambiguity. Issue #162 is closed and its Project item
is `Done`; the closeout continues through current evidence, Archive, exact
cleanup, and terminalization of only this new run.

...
test("every declared v2 record kind has a strict portable fixture", () => {
  const records = [
    ...
    { kind: "cancellation-receipt", schemaVersion: RUN_CONTRACT_VERSION, controllerRunId: "controller-001", parentRunId: "parent-run-001", workUnitId: "work-unit-001", claimId: "claim-001", repositoryId: `r1-${hash("1")}`, approvedChangeId: "example-change", requestDigest: hash("b"), expiresAt: "2026-08-20T16:00:00.000Z", createdAt: "2026-08-20T17:00:00.000Z" }
  ];

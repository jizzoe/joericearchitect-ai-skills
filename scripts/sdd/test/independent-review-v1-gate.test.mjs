...
test("delivery gate accepts one already-durable objective correction", () => {
  ...
  const correction = { id: "correction-1", change: "change", attempt: 1, failureSignature: "review-fixture", classification: "objective-fix", behaviorPreserving: true, current: true, ancestryVerified: true, evidenceReference: "checkpoint:correction-1", baseCommit, previousHead: initialHead, previousManifestDigest: initialManifest, headCommit, manifestDigest: reviewPackage.manifestDigest };

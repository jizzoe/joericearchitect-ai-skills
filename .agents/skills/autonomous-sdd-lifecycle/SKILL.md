...
description: Thin Codex exposure for the canonical autonomous SDD lifecycle skill.
license: MIT
...
This Codex adapter exists only for platform discovery. It must not duplicate
...
regenerate platform exposure before running the autonomous SDD lifecycle.

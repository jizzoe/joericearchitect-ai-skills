...
- [x] 3.3 Perform bounded local security/recovery review, resolve objective findings, record portability and attribution evidence, and document the intentional post-predecessor restoration of the Codex review adapter before delivery. Depends on 3.2.

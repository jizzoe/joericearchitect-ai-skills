...
be an explicitly declared subcommand and MUST accept only a structured request.
The launcher SHALL NOT expose any command that resolves or returns an importable
module path.

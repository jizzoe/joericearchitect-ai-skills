...
as a thin sealed loop. It MUST require fresh review when the sealed package
digest, exact head or tree, artifact manifest, Apply evidence, findings
dispositions, or policy gates change. The reviewer MUST NOT fix the change.

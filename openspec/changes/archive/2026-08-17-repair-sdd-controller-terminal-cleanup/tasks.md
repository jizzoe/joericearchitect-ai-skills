...
- [x] 5.2 Add executable controller transitions for durable resource registration, delivery binding, fresh eligibility inspection, and receipt-coupled cleanup execution and completion invariants.

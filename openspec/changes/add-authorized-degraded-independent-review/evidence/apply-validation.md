...
- `node --test $(rg --files | rg '\.test\.mjs$')` — 190 passing tests covering authorization, strict-first execution, launcher recovery, concise-request resolution, checkpoint/delivery bindings, findings, detached view, portability, secrets, and adapter boundaries.

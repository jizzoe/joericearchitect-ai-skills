...
- [x] 1.1 Add `skills/base/generic-git-repository-cleanup/SKILL.md` describing
...
- [x] 1.2 Add the runtime helper `scripts/sdd/generic-git-repository-cleanup.mjs`
  ...
  Depends on: 1.1.
- [x] 1.3 Add thin Claude and Codex discovery adapters under `.claude/skills/`
  and `.agents/skills/` pointing to the canonical skill without duplicating
  policy. Depends on: 1.1.

## 2. Classification and selection

- [x] 2.1 Implement deterministic retire-eligibility classification (delivered to
...
- [x] 2.2 Implement conservative commit-candidate grouping (out-of-scope,
...
- [x] 2.3 Implement the fresh-reinspection gate and exact Git command adapters
...
- [x] 6.2 Implement the spec/non-spec direct-commit split: spec-governed content
...
- [x] 6.3 Add regression coverage for remote-merge gating and the spec/non-spec
